...
let Rental = (_dec = (0, _typeorm.Entity)("rentals"), _dec2 = Reflect.metadata("design:type", Function), _dec3 = Reflect.metadata("design:paramtypes", []), _dec4 = (0, _typeorm.PrimaryColumn)(), _dec5 = Reflect.metadata("design:type", String), _dec6 = (0, _typeorm.ManyToOne)(() => _Car.Car), _dec7 = (0, _typeorm.JoinColumn)({
  ...
  // relacina tabelas para busca (RentalsRepository)
  ...
  constructor() {
    ...
    _initializerDefineProperty(this, "update_at", _descriptor10, this);
    if (!this.id) {
      this.id = (0, _uuid.v4)();
    }
  }
  ...
  writable: true,
  initializer: null
}), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, "update_at", [_dec23, _dec24], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
